If you would like to contribute to the IATI Extra Documentation project, you can....
...
* each version of the IATI Standard to which this documentation refers has its own branch. e.g. version-2.01
