...
| Codelists are updated through a :doc:`managed process </codelists-guides/codelist-management>`.  A codelist can either be embedded (centrally managed by IATI) or non-embedded (derived from an authority source).
