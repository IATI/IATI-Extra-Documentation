...
2.03
^^^^
Updated the ``@vocabulary`` attribute `definition - removed the % sign  <https://discuss.iatistandard.org/t/bug-fix-implementing-checks-on-percentage-attributes/983>`__
