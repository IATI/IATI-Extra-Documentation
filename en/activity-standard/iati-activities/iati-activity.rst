...
| The optional ``@linked-data-uri`` attribute is included.
| The optional ``@budget-not-provided`` attribute is included.
...
2.03
^^^^
| The ``budget-not-provided`` attribute was added <add link>.
